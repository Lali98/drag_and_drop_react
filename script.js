...
function Doboz(props) {
    var _React$useState = React.useState({ x: props.x, y: props.y, isDragged: false }),
    ...
    return React.createElement(
        'div',
        { className: 'box ' + (state.isDragged ? 'grabbed' : 'not-grabbed'),
...
ReactDOM.render(React.createElement(
    'div',
    null,
    React.createElement(Doboz, { x: '0', y: '100', szam: '1' }),
    React.createElement(Doboz, { x: '200', y: '100', szam: '2' }),
    React.createElement(Doboz, { x: '400', y: '100', szam: '3' })
